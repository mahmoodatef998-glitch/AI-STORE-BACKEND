...
-- Trigger to auto-update updated_at for equipments
CREATE TRIGGER update_equipments_updated_at
    BEFORE UPDATE ON equipments
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

-- Trigger to auto-update updated_at for suppliers
...
-- Trigger to auto-decrement quantity when consumption is logged
...
-- Trigger to check low stock after inventory update
